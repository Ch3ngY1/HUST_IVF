...
class Ada(nn.Module):
    def __init__(self, init_function, num_classes=2, num_frame=96, position_mode='add', c_trans=False):
        ...
        self.first = nn.Conv2d(1, 96, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        self.base = densenet121(pretrained=True)
        self.feature = nn.Sequential(self.first, *list(self.base.children())[0][1:-1])
