...
# Config Path set
__C.ModelSave_Path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../..', 'Savings/save_models'))
__C.TensorboardSave_Path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../..', 'Savings/tensorboardx'))
